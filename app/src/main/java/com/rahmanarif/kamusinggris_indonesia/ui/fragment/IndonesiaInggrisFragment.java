...
public class IndonesiaInggrisFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listKata = v.findViewById(R.id.listKosakata);
    ...
    private void loadVocab() {
        ...
        listKata.setLayoutManager(new LinearLayoutManager(getContext()));
        listKata.setAdapter(adapter);
        try {
            kamusDbHelper.open();
            kamuses = kamusDbHelper.getAllData(false);
    ...
    private void loadVocab(String newText) {
        ...
        try {
            kamusDbHelper.open();
            kamuses = kamusDbHelper.getDataSearch(newText, false);
            Log.d("listKamus", kamuses.toString());
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
